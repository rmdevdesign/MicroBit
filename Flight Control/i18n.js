...
const dictionary = {
  fr: {
    ...
    "home.title": "Volez avec votre micro:bit",
    "home.intro": "Inclinez la manette, l'avion 3D suit.",

    "step1.title": "1. Préparer le micro:bit",
    ...
    "phone.text": "Utilisez votre téléphone : tenez-le droit comme un volant, et inclinez-le.",
  ...
  en: {
    ...
    "brand.aria": "RM Dev Design — rmdev.design",
    "home.title": "Fly with your micro:bit",
    "home.intro": "Tilt the controller, the 3D plane follows.",

    "step1.title": "1. Set up the micro:bit",
    ...
    "phone.text": "Use your phone: hold it upright like a steering wheel, and tilt it.",
